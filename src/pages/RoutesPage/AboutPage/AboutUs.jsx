          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 items-center">
            <div className="order-1">
              <div className="relative">
                ...
                <div className="hidden sm:block absolute -bottom-6 -right-6 w-32 h-32 bg-gray-300 rounded-full opacity-20 blur-3xl"></div>
              </div>
            </div>
            ...
            <div className="order-2">
              <div className="mb-6">
                <div className="flex items-center mb-4">
                  <div className="w-12 h-0.5 bg-black mr-3"></div>
                  <span className="text-black text-sm tracking-widest uppercase font-semibold">Who I Am</span>
                </div>
              ...
              <div className="space-y-4 sm:space-y-5">
                <p className="text-sm sm:text-base text-gray-500 leading-relaxed">
                  Chiropractic mind is the act of utilizing spinal arrangement to ease a wide assortment
                  of physical infirmities, including muscle strain, neck torment, endless back torment,
                  and then some.
                </p>
                <p className="text-sm sm:text-base text-gray-500 leading-relaxed">
                  At Healing Chiropractic our chiropractic group is prepared to address with you to
                  talk about your issues. We will outline a program that is appropriate for you.
                </p>
              </div>
              ...
              <div className="mt-6 sm:mt-8">
                <div className="w-48 h-20 relative">
                  <svg viewBox="0 0 200 80" className="w-full h-full">
                    <path d="M10 40 Q 30 10, 50 40 T 90 40 Q 110 60, 130 40 T 170 40" stroke="#000000" strokeWidth="2" fill="none" strokeLinecap="round"/>
                    <path d="M30 50 Q 40 30, 60 50" stroke="#000000" strokeWidth="2" fill="none" strokeLinecap="round"/>
                  </svg>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 items-center">
            <div className="order-2 lg:order-1">
              <div className="mb-6">
                <div className="flex items-center mb-4">
                  <div className="w-12 h-0.5 bg-black mr-3"></div>
                  <span className="text-black text-sm tracking-widest uppercase font-semibold">About Clinic</span>
                </div>
              ...
              <div className="space-y-4 sm:space-y-5 mb-8">
                <p className="text-sm sm:text-base text-gray-500 leading-relaxed">
                  ...
                  At the end of the day, evolved from generation X is on the runway heading towards
                  a streamlined cloud solution.
                </p>
                <p className="text-sm sm:text-base text-gray-500 leading-relaxed">
                  Capitalize on low hanging fruit to identify a ballpark value added activity to beta
                  test. Override the digital divide with additional clickthroughs from clinic.
                </p>
              </div>
            </div>
